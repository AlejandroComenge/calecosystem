...
- [ ] **Build de publicacion.** Los paquetes apuntan a `src/*.ts`; hay que
      ...
      para publicar.
- [ ] Versionado y publicacion coordinada de los ocho paquetes.
...
## v0.3 — los modulos dejan de ser vista previa
...
|-------|---------|--------|
| `exports` apuntando a `src/` | Bloquea la publicacion en npm | v0.2 |
| Fase `augment` secuencial | Irrelevante hoy, critico con modulos remotos | v0.4 |
...
| Sin cache de analisis | Irrelevante a 40 ms, no con un LLM | junto con v0.4 |
